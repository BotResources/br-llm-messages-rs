...
If you believe you have found a security issue in this repository, email
**security@botresources.ai** with:
...
We support the latest tag (`v{version}`). Older tags receive no fixes; upgrade
to the latest.
